...
**Answer So that we don't lose any of the data we have created before. We would lose information.**
...
**Answer It gives us all the theater values OR all the seat values.**
...
1.  Out of the journalism department, what course offers the most seats in the term of 2021?

2.  What was the highest amount of money the Dundalk Eagle Newspaper paid in the "maryland_expenses" dataset?

3.  What county had the highest number of votes in the "general_22" dataset?
